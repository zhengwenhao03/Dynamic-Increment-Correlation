...
def plot_damaged_joints_comparison(alpha_list, dyn_indicators_all, tot_indicators_all, damaged_joints_list):
    ...
    for idx, j in enumerate(damaged_joints_list):
        ...
        plt.plot(
            ...
            label=f'Joint {j+1} (Total Strain)'
        )
        ...
        plt.plot(
            ...
            label=f'Joint {j+1} (Dynamic Increment)'
        )
    
    plt.xlim(0.0, 1.0)
    plt.ylim(0.0, 1.0)
    plt.xlabel(r'Stiffness Reduction Factor', fontsize=12, fontweight='bold')
...
def plot_multi_joint_degradation(alpha_list, dyn_indicators_all, target_joints_list):
    ...
    plt.xlim(0.0, 1.0)
    plt.ylim(0.0, 1.0)
    plt.xlabel(r'Stiffness Reduction Factor', fontsize=13, fontweight='bold')
